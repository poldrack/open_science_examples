...
out_path = Path('../processed_data/powersim_nosite')
if not out_path.exists():
    out_path.mkdir()

results_sim.to_csv(str(out_path) + '/power_sim_mixedmodel_nosite_%s.csv' % run_string)
with open(str(out_path) + '/power_sim_mixedmodel_nosite_%s.pkl' % run_string, 'wb') as f:
